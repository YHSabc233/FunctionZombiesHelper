...
import top.yhsabc233.fzh.features.ShowSpawnTime;
...
import static top.yhsabc233.fzh.util.StringUtils.getNumbersFromString;
	...
	public static void sstRender(DrawContext context) {
		if (FzhConfig.CONFIG.isEnabled && FzhConfig.CONFIG.sstSwitch) {
			...
			try {
				...
				if (gameRoundScoreboardTeam == null || gameMapScoreboardTeam == null || gameLeftZombiesTeam == null || gamePlayersTeam == null) {
					return;
				}
